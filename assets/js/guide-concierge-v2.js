(function(){
  ...
  function show(message,actions,label="SAKU+MERU 案内人"){
    ...
    host.hidden=false;launcher.setAttribute("aria-expanded","true");host.querySelector("img").onerror=()=>{host.classList.add("no-art");host.querySelector("figure").hidden=true};host.querySelector("[data-guide-close]").onclick=close;
  }
  ...
  launcher.onclick=conciergeMenu;
})();
